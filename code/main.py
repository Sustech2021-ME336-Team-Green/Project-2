...
def detectObject(detector_algo: Yolo5, color, crop_bounding=[184, 563, 325, 1051]):
...
if __name__ == '__main__':
    ...
    while 1:
        ...
        # Todo: filter plane
        plane_model = [-0.02386709, 0.14317351, 0.61387388, -0.77594495]
        #plane_model = [0.02114119,-0.14073077,-0.61469684,0.77581937]
        new_pc = []
